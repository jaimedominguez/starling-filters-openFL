...
class FragmentFilter
{
    ...
    public function new(numPasses : Int = 1, resolution : Float = 1.0)
    {
        if (Capabilities.isDebugger &&
            Type.getClassName(Type.getClass(this)) == "starling.filters::FragmentFilter")
        {
            ...
            parentAlpha : Float, intoCache : Bool = false) : QuadBatch
    {
        ...
        var previousStencilRefValue : Int;
            ...
            resultPotRect : Rectangle) : Void
    {
        ...
        // the bounds are a rectangle around the object, in stage coordinates,
            ...
            resultPotRect.setTo(
                    ...
                    getNextPowerOfTwo(Std.int(minWidth * scale)) / scale, 
                    getNextPowerOfTwo(Std.int(minHeight * scale)) / scale
            );
        }
    }
    ...
    private function disposePassTextures() : Void
    {
        ...
        as3hx.Compat.setArrayLength(mPassTextures, 0);
    }
    ...
    @:final private function get_vertexPosAtID() : Int
    {
        return mVertexPosAtID;
    }
    @:final private function set_vertexPosAtID(value : Int) : Int
    {
    ...
    @:final private function get_texCoordsAtID() : Int
    {
        return mTexCoordsAtID;
    }
    @:final private function set_texCoordsAtID(value : Int) : Int
    {
    ...
    @:final private function get_baseTextureID() : Int
    {
        return mBaseTextureID;
    }
    @:final private function set_baseTextureID(value : Int) : Int
    {
    ...
    @:final private function get_mvpConstantID() : Int
    {
        return mMvpConstantID;
    }
    @:final private function set_mvpConstantID(value : Int) : Int
    {
