...
class BlurFilter extends FragmentFilter
{
    ...
    public static function createGlow(color : Int = 0xffff00, alpha : Float = 1.0, blur : Float = 1.0,
            resolution : Float = 0.5) : BlurFilter
    {
    ...
    private function updateParameters(pass : Int, textureWidth : Float, textureHeight : Float) : Void
